      ...
      <main className="text-center">
        ...
        <div className="row featurette">
          <div className="col-md-7 order-md-2">
            ...
            <p className="lead">Available for free download on Windows <i style={{ color: '#00A4EF' }} className="fab fa-windows" />, Mac <i className="fab fa-apple" /> and Linux <i className="fab fa-linux" />.</p>
          </div>
