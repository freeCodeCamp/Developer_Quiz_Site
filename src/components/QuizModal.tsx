...
const QuizModal: React.FC<QuizQuestion> =
  (QuizQuestion) => {
      ...
      <>
        <Modal className="modal-styles" show={QuizQuestion.show}>
          ...
          <Modal.Body>
            ...
            <a className="modal-link" href={QuizQuestion.showReference} target="_blank" rel="noopener noreferrer">Learn more with this helpful resource</a>
            <br />
            <br />
