const freecodecampQuiz = [
  ...
  {
    Question:
      "Which section of freeCodeCamp's curriculum focuses on JavaScript algorithms and data structures?",
    ...
    Explanation:
      "The 'JavaScript Algorithms and Data Structures Certification' is dedicated to teaching fundamental concepts related to algorithms and data structures.",
