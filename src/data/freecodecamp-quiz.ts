const freecodecampQuiz = [
  ...
  {
    Question: "What chat tool does freeCodeCamp use for its main chat server?",
    Answer: "Discord",
    Distractor1: "Slack",
  ...
  {
    Question: "Who is the founder of freeCodeCamp?",
  ...
  {
    Question:
      "What was the secret keyword freeCodeCamp asked contributors to include in the request mail to confirm they read the publication guideline",
    Answer: "bananas",
    Distractor1: "mascot",
    Distractor2: "hello world",
    Distractor3: "freeCodeCamp",
    Explanation:
      "The secret keyword freeCodeCamp requested in their medium publication style guide is bananas",
    Link: "https://www.freecodecamp.org/news/how-to-get-published-in-the-freecodecamp-medium-publication-9b342a22400e/",
  },
];
