const htmlQuiz = [
  ...
  {
    Question: "In HTML, what does the lang attribute do in the html tag?",
    Answer: "Helps determines the language of the document",
    Distractor1: "Defines the html size",
    Distractor2: "Determines the document time zone",
    Distractor3: "Determines the document country",
    Explanation:
      "The lang attribute helps define the language of an element, and since html represents the document, it defines the document language.",
