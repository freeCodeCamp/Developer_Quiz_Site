const linuxQuiz = [
  {
    Question: "In Linux, which option is used with uname command to print the node network name?",
    Answer: "-n",
    Distractor1: "-network",
    Distractor2: "-node",
    Distractor3: "-ntwrk",
    Explanation:
        "In Linux , -n option can be used with uname command to print the node network name.",
