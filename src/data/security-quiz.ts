const securityQuiz = [
  ...
  "Explanation": "WebAuthn allows passwordless authentication using public key cryptography, offering stronger protection against phishing. Unlike traditional passwords, it ensures credentials are stored securely on the device itself.",
    For more details, check out this freeCodeCamp youtube video tutorial at https://youtu.be/F-sFp_AvHc8?si=8VbYmxp-b3kP3NG7&t=10222.
