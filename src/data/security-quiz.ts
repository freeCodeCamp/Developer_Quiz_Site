const securityQuiz = [
  ...
  "Explanation": "WebAuthn is designed to provide a secure and passwordless authentication method using public key cryptography, making it more resistant to phishing attacks.",
