const sqlQuiz = [
  {
    ...
    Answer: "CREATE TABLE table_name (column1_name datatype, column2_name datatype)",
    Distractor1: "CREATE TABLE table_name (column1_name, column2_name )",
    Distractor2: "UPDATE TABLE table_name (column1_name datatype, column2_name datatype)",
    Distractor3: "CREATE NEW TABLE table_name (column1_name datatype, column2_name datatype)",
  ...
  {
    Question: "In SQL, what command is used to convert from one datatype to another?",
    Answer: "CAST()",
    Distractor1: "CHANGE()",
    Distractor2: "TYPE()", 
    Distractor3: "CONVERT()",
    Explanation: "The CAST() function is used to convert a column in a table from one datatype to another.",  
    Link: "https://www.freecodecamp.org/news/cast-a-function-in-sql-convert-char-to-int-sql-server-example/",
  },
  {
    Question: "In SQL, which of the following is the correct syntax for inserting a new record(row) to a table?",
    Answer: "INSERT INTO table_name (column1, column2, column3) VALUES (value1, value2, value3);", 
    Distractor1: "ADD ROW table_name (column1, column2, column3) VALUES (value1, value2, value3);",
    Distractor2: "ALTER table_name (value1, value2);",
    Distractor3: "INSERT INTO table_name (column1, column2, column3) VALUES (value1, value2);",
    Explanation: "The INSERT INTO statement is used to add new rows to a table, with the number of values equal to the number of specified columns", 
