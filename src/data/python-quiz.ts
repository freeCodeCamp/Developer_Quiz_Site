const pythonQuiz = [
  ...
  { 
    ...
    Distractor3: "piip", 
    Explanation: "", 
    Link: "https://en.wikipedia.org/wiki/Pip_(package_manager)", 
  },
  { 
    Question: "What is the output of print(math.pow(3,4))?",
    Answer: "81.0", 
    Distractor1: "81", 
    Distractor2: "81.0", 
    Distractor3: "34", 
    Explanation: "By the default math.pow() converts both its arguments to type float", 
    Link: "https://docs.python.org/3/library/math.html#power-and-logarithmic-functions", 
  },
  { 
    Question: "Which of the following is not a tuple method?",
    Answer: "insert", 
    Distractor1: "count", 
    Distractor2: "insert", 
    Distractor3: "index", 
  ...
  { 
    Question: "What will be the data type of 'John Doe'.split()?",
    Answer: "List", 
    Distractor1: "string", 
    Distractor2: "List", 
    Distractor3: "tuple", 
  ...
  { 
    Question: "If my_nums = [8,9,10], which of the following can't be used to reverse the list?",
  ...
  { 
    Question: "Which built-in function returns all properties and methods of the specified object, without the values?",
    Answer: "dir()", 
    Distractor1: "obj()", 
    Distractor2: "dir()", 
    Distractor3: "all()", 
    Explanation: "The dir() function will return all the properties and methods, even built-in properties which are default for all object.", 
    Link: "https://docs.python.org/3/library/functions.html#dir", 
  },
  { 
    Question: "If num = 1.2345, print('%.2f' %num) will give?",
    Answer: "1.23", 
    Distractor1: "1.23", 
    Distractor2: "12.3", 
    Distractor3: "1.2", 
