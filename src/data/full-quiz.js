const fullQuiz = [
  ...
  {
    Question: "A variable that has been declared and assigned a value of 'no value' is ___________________",
    Answer: "null",
  ...
  {
    Question: "In a switch statement, the __________________ case executes if none of the options are true.",
    Answer: "default",
  ...
  {
    Question: "Which comparison operator is used to express strict equality in JavaScript?",
    Answer: "===",
    Distractor1: ">=",
    Distractor2: "+=",
    Distractor3: "<=",
  ...
  },
  {
    ...
    Distractor2: "Java",
    Distractor3: "C++",
    Explanation: "C is not an Object-Oriented Language,hence function overloading is not possible",
    Link: "https://www.freecodecamp.org/news/object-oriented-programming-in-c/",
  },
  {
    Question: "Which of the following Data Structure is used to convert an infix expression to postfix expression?",
    Answer: "Stacks",
    Distractor1: "Queues",
    Distractor2: "Priority Queues",
    Distractor3: "LinkedList",
    Explanation: "Stack is most suitable data structure for converting an infix expression to postfix expression",
    Link: "https://www.freecodecamp.org/news/understand-data-structures-in-c-and-cpp/",
  },
  {
    Question: "Which of the following technique is implemented to improve CPU performance?",
    Answer: "Pipelining",
