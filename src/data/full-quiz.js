const fullQuiz = [
    ...
    Explanation: "The nullish coalesce operator in Javascript returns first expression if it is not null or undefined, else it returns second expression.",
    Link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing_operator",
  },
  {
    Question: "What object does this keyword point to in global execution context?",
    Answer: "window",
    Distractor1: "null",
    Distractor2: "undefined",
    Distractor3: "document",
    Explanation: "In global execution context, this keyword always points to window object",
    Link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this",
  },
  {
    Question: "Which queue is emptied first by Javascript event loop?",
    Answer: "Microtask queue",
    Distractor1: "Callback queue (Macrotask queue)",
    Distractor2: "None",
    Distractor3: "Both",
    Explanation: "Event loop first empties the Microtask queue and once its empty, starts to empty Callback queue",
    Link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop",
  },
  {
    Question: "Which of the following is not in Temporal Dead Zone(TDZ) during hoisting?",
    Answer: "var",
    Distractor1: "let",
    Distractor2: "const",
    Distractor3: "class",
    Explanation: "var is hoisted with default value of undefined. While let, const and classes are hoisted but are in Temporal Dead Zone(TDZ) until declaration is executed.",
  ...
  },
  {
    ...
    Distractor2: "null === 0",
    Distractor3: "null > 0",
    Explanation: "The >= operator will convert null to 0, which will return true. But in == operator, null only equals to undefined. Because of this null <= will also be true.",
    Link: "https://stackoverflow.com/questions/2910495/why-null-0-null-0-but-not-null-0",
  },
  {
    ...
    Explanation: "console is part of a web API which is provided by browsers and nodejs.",
    Link: "https://developer.mozilla.org/en-US/docs/Web/API/console",
  },
  {
    Question: "Which of the following method returns a function?",
    Answer: "bind",
    Distractor1: "apply",
    Distractor2: "call",
    Distractor3: "None of given",
    Explanation: "The bind functions returns a new function with given arguement as the new function's this keyword.",
  ...
  },
  {
    ...
    Answer: "The ability to send and receive functions like value.",
    ...
    Link: "https://www.geeksforgeeks.org/difference-between-first-class-and-higher-order-functions-in-javascript/",
  },
  {
  ...
  {
    Question: "Which of the following methods returns the day of the month for the specified date according to local time?",
    Answer: "getDate()",
  ...
  {
    Question: "Which of the following methods returns the day of the week for the specified date according to local time?",
    Answer: "getDay()",
    Distractor1: "getDate()",
  ...
  {
    Question: "Which of the following methods returns the year of the specified date according to local time?",
    Answer: "getFullYear()",
    Distractor1: "getDate()",
  ...
  {
    Question: "Which of the following methods returns the day of the hour for the specified date, according to local time?",
    Answer: "getHours()",
  ...
  {
    Question: "Which of the following methods returns the milliseconds in the specified date according to local time?",
  ...
  {
    Question: "Which of the following methods returns the minutes in the specified date according to local time?",
    Answer: "getMinutes()",
    Distractor1: "getMin()",
    Distractor2: "getMilliseconds()",
  ...
  {
    Question: "Which of the following methods returns the month in the specified date according to local time, as a zero-based value?",
    Answer: "getMonth()",
  ...
  {
    Question: "Which of the following methods returns the seconds in the specified date according to local time?",
    Answer: "getSeconds()",
    Distractor1: "getSec()",
  ...
  {
    Question: "Which of the following methods returns the number of milliseconds since the Unix Epoch?",
    Answer: "getTime()",
  ...
  },
  {
    ...
    Explanation: "Code Radio is available 24/7, with more than 1,500 instrumental songs on rotation. Lots of developers enjoy listening to it as background music while they work.",
