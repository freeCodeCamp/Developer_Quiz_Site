const fullQuiz = [
  {
    Question: "Select the right syntax of the Arrow function (ES6)?",
    ...
    Explanation: "ES6 arrow functions provide you with an alternative way to write a shorter syntax compared to the function expression.",
